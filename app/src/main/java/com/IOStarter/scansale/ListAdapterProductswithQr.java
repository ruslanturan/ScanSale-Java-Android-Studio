...
public class ListAdapterProductswithQr extends ArrayAdapter<ClassProducts> {
    /* access modifiers changed from: private */
    public Context psContext;
    int psResource;

    public ListAdapterProductswithQr(Context context, int i, ArrayList<ClassProducts> arrayList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ListAdapterProductswithQr.this.psContext.startActivity(new Intent(ListAdapterProductswithQr.this.psContext, ActivityProduct.class));
